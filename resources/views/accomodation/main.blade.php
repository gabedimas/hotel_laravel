                ...
                <div class="row hotel_booking_table">
                    ...
                    <div class="col-md-9">
                        <div class="boking_table">
                            <form action="/booking/list" method="GET" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="book_tabel_item">
                                            <div class="form-group">
                                                <div class='input-group date' id='datetimepicker11' name="tanggal_awal">
                                    ...
                                    <div class="col-md-4">
                                        <div class="book_tabel_item">
                                            <div class="form-group">
                                                <div class='input-group date' id='datetimepicker1' name="tanggal_akhir">
